...
$membership=new Membership();
    ...
    {
          $books->addToShelf($_REQUEST['book'], $ip_add);
  }
...
if (! empty($bookItem)) {
    ...
    if (! empty($bookItem)) {
        foreach ($bookItem as $book) {
          ...
          <div class="image_panel"><img src="images/<?php echo $book_image ?>" alt="image" width="100" height="150" /></div>
                </td>
                <td>
    ...
    <div id="templatemo_footer">
	       ...
	       <center><a href="index.php">Home</a> | <a href="about.php">About</a> | <a href="uploadBooks.php">Upload books</a> |  <a href="contact.php">Contact Us</a><br />
